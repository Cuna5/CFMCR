# DACR: Degradation-Adaptive Consistency Flow Matching for One-Step Cloud Removal from Optical Satellite Images
## :tada:项目的使用方法
### :wrench:环境配置
...
```
但是其实这条命令会从头编译`flash_attn`，非常消耗时间。为了加速安装，可以从[`flash_attn`的官方仓库](https://github.com/Dao-AILab/flash-attention)下载一下wheel文件（注意是`2.5.9.post1`版本的wheel文件），或者[点击此处下载](https://drive.google.com/file/d/1Oqrmr6hhhuEoVbaFzbDnVA_tGkt3NCVG/view?usp=sharing)，然后使用下面的命令从wheel文件安装包：
```bash
...
```
同样这条命令会从头编译`natten`，很耗时间。你也可以到[`natten`的官方仓库](https://github.com/SHI-Labs/NATTEN/)下载wheel文件来加速。但是`natten`官方将他们的wheel文件放到了一个网站上，所以你可以通过`pip -f`指定wheel所在的网站来进行`natten`的下载，或者[点击此处下载](https://drive.google.com/file/d/1E9E71YK5PkF3ZypkKy0_P0gn_UPFQpRz/view?usp=sharing)：
```bash
...
### :pushpin:数据集
我们使用了四个数据集：CUHK-CR1，CUHK-CR2，RICE1，RICE2。你需要先把这些数据集下载好。

下面我们提供了下载这些数据集的网址：

|数据集| 网址 |
|-------|-----|
|CUHK-CR1| [https://drive.google.com/file/d/1TVyvQHjccVpO8bvb451fEAVGkmzc4WWw/view?usp=drive_link](https://drive.google.com/file/d/1TVyvQHjccVpO8bvb451fEAVGkmzc4WWw/view?usp=drive_link) |
|CUHK-CR2| [https://drive.google.com/file/d/1TVyvQHjccVpO8bvb451fEAVGkmzc4WWw/view?usp=drive_link](https://drive.google.com/file/d/1TVyvQHjccVpO8bvb451fEAVGkmzc4WWw/view?usp=drive_link) |
|RICE1| [https://drive.google.com/file/d/1y1tlmcUw0E44CrLlfCfQLKn-bgL2i6Iy/view?usp=drive_link](https://drive.google.com/file/d/1y1tlmcUw0E44CrLlfCfQLKn-bgL2i6Iy/view?usp=drive_link)|
|RICE2|[https://drive.google.com/file/d/1y1tlmcUw0E44CrLlfCfQLKn-bgL2i6Iy/view?usp=drive_link](https://drive.google.com/file/d/1y1tlmcUw0E44CrLlfCfQLKn-bgL2i6Iy/view?usp=drive_link)|
